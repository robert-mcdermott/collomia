...
| provider | model/capability discovery | unsupported | models come from configuration only |
...
| tools | run_command | implemented | process-group kill, timeout, output caps, conservative command analysis |
