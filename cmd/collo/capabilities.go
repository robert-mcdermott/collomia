...
func capabilityMatrix() []capabilityRow {
	...
	return []capabilityRow{
		...
		{"provider", "protocol contract suite", "experimental", "recorded streaming/tool/usage/error/truncation fixtures cover OpenAI, Anthropic, Responses/Mantle, and Bedrock ConverseStream; opt-in live contracts remain"},
