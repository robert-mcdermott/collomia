...
func capabilityMatrix() []capabilityRow {
	...
	return []capabilityRow{
		...
		{"subagents", "structured results and conflict detection", "implemented", "bounded per-child status/summary/evidence/usage/change manifests plus durable machine-observed verification; same-file siblings get common-base hunk overlap analysis; nothing is auto-ranked or reconciled"},
