...
func capabilityMatrix() []capabilityRow {
	...
	return []capabilityRow{
		...
		{"mcp", "elicitation / progress / subscriptions / oauth", "unsupported", "roadmap phase 5"},
		...
		{"interface", "TUI (themes, palette, tabs, status bar)", "implemented", "11 themes incl. `plain`; NO_COLOR honored; fuzzy pickers for models, themes, sessions, files, skills, and MCP servers; informational slash commands render as titled panels with a theme-tinted body"},
