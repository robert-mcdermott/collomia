...
func capabilityMatrix() []capabilityRow {
	...
	return []capabilityRow{
		...
		{"interface", "TUI (themes, palette, tabs, status bar)", "implemented", "11 themes incl. `plain`; NO_COLOR honored; fuzzy pickers stay compact; approvals, hunk review, and questions use centered theme-aware dialogs; Markdown/read_file/diff source is syntax-highlighted"},
