...
func capabilityMatrix() []capabilityRow {
	...
	return []capabilityRow{
		...
		{"quality", "offline agent evaluations", "experimental", "credential-free real agent/permission/tool/session scenarios cover repository inspection, bug fix plus verification, permission refusal, interrupted mutation recovery, long-context plan/failure retention, and non-replaying rewind; broader task corpus remains roadmap work"},
